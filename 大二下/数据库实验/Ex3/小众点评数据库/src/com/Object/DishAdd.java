...
public class DishAdd extends JPanel {
	...
	public DishAdd() {
		...
		JLabel lblNewLabel_3 = new JLabel("好评次数");
		lblNewLabel_3.setBounds(358, 255, 58, 15);
		add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("所属商家");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String sql="insert into DISH VALUES('"+t2.getText()+"','"+t1.getText()+"',"+t3.getText()+",'"+t4.getText()+"','"+t5.getText()+"')";
